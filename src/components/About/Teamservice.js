    ...
    return (
      <div>
        <div class="card-group">
          <div class="card">
            <img
              src="https://images.pexels.com/photos/7114/laptop-mobile.jpg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940"
              class="card-img-top"
              alt="..."
            />
            <div class="card-body">
          ...
          <div class="card">
            <img
              src="https://images.pexels.com/photos/7361/startup-photos.jpg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940"
              class="card-img-top"
              alt="..."
            />
            <div class="card-body">
              ...
              <p class="card-text">
                Developers at Raga Designers are skilled and experience in using
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <p class="card-text">
                We let your products reach a wider audience. Kick start your
                online business with the best performing E-commerce website
              </p>
              <p class="card-text">
                <small class="text-muted">Last updated 3 mins ago</small>
              </p>
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <p class="card-text">
                Our SEO experts utilize the keywords to the fullest to rank
                high. We make your website get optimized as per the Search
                engine criteria.
              </p>
              <p class="card-text">
                <small class="text-muted">Last updated 3 mins ago</small>
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <p class="card-text">
                The user-friendly and responsive mobile applications make your business easily approachable for the clients.
              </p>
              <p class="card-text">
                <small class="text-muted">Last updated 3 mins ago</small>
              </p>
